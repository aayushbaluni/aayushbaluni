...
|------------|-------|-----|---------------------|
| [**dify**](https://github.com/langgenius/dify) | ⭐ 156.7k | 1 | [#35263](https://github.com/langgenius/dify/pull/35263) — fix: apply score threshold after reranking in hybrid search |
| [**langflow**](https://github.com/langflow-ai/langflow) | ⭐ 155.1k | 1 | [#12712](https://github.com/langflow-ai/langflow/pull/12712) — fix: strip reserved 'code' param before build() in compon... |
...
| [**twenty**](https://github.com/twentyhq/twenty) | ⭐ 57.2k | 1 | [#20192](https://github.com/twentyhq/twenty/pull/20192) — fix: handle missing file entity in avatar deletion listener |
...
| [**serena**](https://github.com/oraios/serena) | ⭐ 29.7k | 1 | [#1884](https://github.com/oraios/serena/pull/1884) — fix(clojure): declare didChangeWatchedFiles client capabi... |
...
| [**effect**](https://github.com/Effect-TS/effect) | ⭐ 16.2k | 1 | [#6178](https://github.com/Effect-TS/effect/pull/6178) — fix(ai-openai): deduplicate response.output items to prev... |
...
| [**sdk-typescript**](https://github.com/temporalio/sdk-typescript) | ⭐ 920 | 1 | [#2036](https://github.com/temporalio/sdk-typescript/pull/2036) — fix: clean up childWorkflowComplete entry on child start ... |
<!-- CONTRIBUTIONS:END -->
