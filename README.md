...
|------------|-------|-----|---------------------|
| [**dify**](https://github.com/langgenius/dify) | ⭐ 156.8k | 1 | [#35263](https://github.com/langgenius/dify/pull/35263) — fix: apply score threshold after reranking in hybrid search |
...
| [**sdk-typescript**](https://github.com/temporalio/sdk-typescript) | ⭐ 921 | 1 | [#2036](https://github.com/temporalio/sdk-typescript/pull/2036) — fix: clean up childWorkflowComplete entry on child start ... |
<!-- CONTRIBUTIONS:END -->
