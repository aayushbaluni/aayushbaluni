...
|------------|-------|-----|---------------------|
| [**dify**](https://github.com/langgenius/dify) | ⭐ 154.2k | 1 | [#35263](https://github.com/langgenius/dify/pull/35263) — fix: apply score threshold after reranking in hybrid search |
| [**langflow**](https://github.com/langflow-ai/langflow) | ⭐ 154.1k | 1 | [#12712](https://github.com/langflow-ai/langflow/pull/12712) — fix: strip reserved 'code' param before build() in compon... |
| [**grafana**](https://github.com/grafana/grafana) | ⭐ 76.6k | 1 | [#123976](https://github.com/grafana/grafana/pull/123976) — fix: normalize undefined and empty array in adHocVariable... |
| [**twenty**](https://github.com/twentyhq/twenty) | ⭐ 56.0k | 1 | [#20192](https://github.com/twentyhq/twenty/pull/20192) — fix: handle missing file entity in avatar deletion listener |
...
| [**Scrapegraph-ai**](https://github.com/ScrapeGraphAI/Scrapegraph-ai) | ⭐ 30.4k | 1 | [#1126](https://github.com/ScrapeGraphAI/Scrapegraph-ai/pull/1126) — fix(graph): expose when the 8192 token fallback was used |
| [**serena**](https://github.com/oraios/serena) | ⭐ 28.7k | 1 | [#1884](https://github.com/oraios/serena/pull/1884) — fix(clojure): declare didChangeWatchedFiles client capabi... |
...
| [**effect**](https://github.com/Effect-TS/effect) | ⭐ 15.7k | 1 | [#6178](https://github.com/Effect-TS/effect/pull/6178) — fix(ai-openai): deduplicate response.output items to prev... |
...
| [**sdk-typescript**](https://github.com/temporalio/sdk-typescript) | ⭐ 905 | 1 | [#2036](https://github.com/temporalio/sdk-typescript/pull/2036) — fix: clean up childWorkflowComplete entry on child start ... |
<!-- CONTRIBUTIONS:END -->
