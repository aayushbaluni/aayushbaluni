...
|------------|-------|-----|---------------------|
| [**langflow**](https://github.com/langflow-ai/langflow) | ⭐ 150.3k | 1 | [#12712](https://github.com/langflow-ai/langflow/pull/12712) — fix: strip reserved 'code' param before build() in compon... |
| [**dify**](https://github.com/langgenius/dify) | ⭐ 147.3k | 1 | [#35263](https://github.com/langgenius/dify/pull/35263) — fix: apply score threshold after reranking in hybrid search |
| [**grafana**](https://github.com/grafana/grafana) | ⭐ 75.2k | 1 | [#123976](https://github.com/grafana/grafana/pull/123976) — fix: normalize undefined and empty array in adHocVariable... |
...
| [**twenty**](https://github.com/twentyhq/twenty) | ⭐ 52.0k | 1 | [#20192](https://github.com/twentyhq/twenty/pull/20192) — fix: handle missing file entity in avatar deletion listener |
...
| [**medusa**](https://github.com/medusajs/medusa) | ⭐ 34.8k | 1 | [#15109](https://github.com/medusajs/medusa/pull/15109) — fix(file-s3): encode URL path segments individually to pr... |
...
| [**logto**](https://github.com/logto-io/logto) | ⭐ 13.3k | 1 | [#8747](https://github.com/logto-io/logto/pull/8747) — fix: tighten URL detection in email connector to avoid fa... |
