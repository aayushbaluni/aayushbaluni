...
| [**sdk-typescript**](https://github.com/temporalio/sdk-typescript) | ⭐ 922 | 1 | [#2036](https://github.com/temporalio/sdk-typescript/pull/2036) — fix: clean up childWorkflowComplete entry on child start ... |
<!-- CONTRIBUTIONS:END -->
