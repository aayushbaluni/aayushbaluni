...
|------------|-------|-----|---------------------|
| [**langflow**](https://github.com/langflow-ai/langflow) | ⭐ 153.6k | 1 | [#12712](https://github.com/langflow-ai/langflow/pull/12712) — fix: strip reserved 'code' param before build() in compon... |
| [**dify**](https://github.com/langgenius/dify) | ⭐ 153.2k | 1 | [#35263](https://github.com/langgenius/dify/pull/35263) — fix: apply score threshold after reranking in hybrid search |
| [**grafana**](https://github.com/grafana/grafana) | ⭐ 76.4k | 1 | [#123976](https://github.com/grafana/grafana/pull/123976) — fix: normalize undefined and empty array in adHocVariable... |
...
| [**twenty**](https://github.com/twentyhq/twenty) | ⭐ 55.3k | 1 | [#20192](https://github.com/twentyhq/twenty/pull/20192) — fix: handle missing file entity in avatar deletion listener |
...
| [**serena**](https://github.com/oraios/serena) | ⭐ 28.4k | 1 | [#1884](https://github.com/oraios/serena/pull/1884) — fix(clojure): declare didChangeWatchedFiles client capabi... |
...
| [**effect**](https://github.com/Effect-TS/effect) | ⭐ 15.4k | 1 | [#6178](https://github.com/Effect-TS/effect/pull/6178) — fix(ai-openai): deduplicate response.output items to prev... |
