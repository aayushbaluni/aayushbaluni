...
|------------|-------|-----|---------------------|
| [**dify**](https://github.com/langgenius/dify) | ⭐ 155.5k | 1 | [#35263](https://github.com/langgenius/dify/pull/35263) — fix: apply score threshold after reranking in hybrid search |
...
| [**sdk-typescript**](https://github.com/temporalio/sdk-typescript) | ⭐ 909 | 1 | [#2036](https://github.com/temporalio/sdk-typescript/pull/2036) — fix: clean up childWorkflowComplete entry on child start ... |
<!-- CONTRIBUTIONS:END -->
