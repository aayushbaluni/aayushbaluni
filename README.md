...
|------------|-------|-----|---------------------|
| [**langflow**](https://github.com/langflow-ai/langflow) | ⭐ 148.6k | 1 | [#12712](https://github.com/langflow-ai/langflow/pull/12712) — fix: strip reserved 'code' param before build() in compon... |
| [**dify**](https://github.com/langgenius/dify) | ⭐ 142.0k | 1 | [#35263](https://github.com/langgenius/dify/pull/35263) — fix: apply score threshold after reranking in hybrid search |
| [**Flowise**](https://github.com/FlowiseAI/Flowise) | ⭐ 53.0k | 1 | [#5993](https://github.com/FlowiseAI/Flowise/pull/5993) — fix: migrate Weaviate to weaviate-client v3 for agentKnow... |
...
| [**agno**](https://github.com/agno-agi/agno) | ⭐ 40.2k | 1 | [#7766](https://github.com/agno-agi/agno/pull/7766) — fix: preserve Anthropic server tool content blocks in mes... |
| [**medusa**](https://github.com/medusajs/medusa) | ⭐ 33.8k | 1 | [#15109](https://github.com/medusajs/medusa/pull/15109) — fix(file-s3): encode URL path segments individually to pr... |
...
| [**effect**](https://github.com/Effect-TS/effect) | ⭐ 14.3k | 1 | [#6178](https://github.com/Effect-TS/effect/pull/6178) — fix(ai-openai): deduplicate response.output items to prev... |
