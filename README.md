...
|------------|-------|-----|---------------------|
| [**langflow**](https://github.com/langflow-ai/langflow) | ⭐ 151.6k | 1 | [#12712](https://github.com/langflow-ai/langflow/pull/12712) — fix: strip reserved 'code' param before build() in compon... |
| [**dify**](https://github.com/langgenius/dify) | ⭐ 148.4k | 1 | [#35263](https://github.com/langgenius/dify/pull/35263) — fix: apply score threshold after reranking in hybrid search |
| [**grafana**](https://github.com/grafana/grafana) | ⭐ 75.5k | 1 | [#123976](https://github.com/grafana/grafana/pull/123976) — fix: normalize undefined and empty array in adHocVariable... |
...
| [**twenty**](https://github.com/twentyhq/twenty) | ⭐ 52.8k | 1 | [#20192](https://github.com/twentyhq/twenty/pull/20192) — fix: handle missing file entity in avatar deletion listener |
