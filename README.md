...
|------------|-------|-----|---------------------|
| [**langflow**](https://github.com/langflow-ai/langflow) | ⭐ 152.4k | 1 | [#12712](https://github.com/langflow-ai/langflow/pull/12712) — fix: strip reserved 'code' param before build() in compon... |
| [**dify**](https://github.com/langgenius/dify) | ⭐ 150.2k | 1 | [#35263](https://github.com/langgenius/dify/pull/35263) — fix: apply score threshold after reranking in hybrid search |
| [**grafana**](https://github.com/grafana/grafana) | ⭐ 75.8k | 1 | [#123976](https://github.com/grafana/grafana/pull/123976) — fix: normalize undefined and empty array in adHocVariable... |
| [**Flowise**](https://github.com/FlowiseAI/Flowise) | ⭐ 54.9k | 1 | [#5993](https://github.com/FlowiseAI/Flowise/pull/5993) — fix: migrate Weaviate to weaviate-client v3 for agentKnow... |
| [**twenty**](https://github.com/twentyhq/twenty) | ⭐ 53.6k | 1 | [#20192](https://github.com/twentyhq/twenty/pull/20192) — fix: handle missing file entity in avatar deletion listener |
| [**agno**](https://github.com/agno-agi/agno) | ⭐ 41.4k | 1 | [#7766](https://github.com/agno-agi/agno/pull/7766) — fix: preserve Anthropic server tool content blocks in mes... |
...
| [**medusa**](https://github.com/medusajs/medusa) | ⭐ 35.4k | 1 | [#15109](https://github.com/medusajs/medusa/pull/15109) — fix(file-s3): encode URL path segments individually to pr... |
...
| [**windmill**](https://github.com/windmill-labs/windmill) | ⭐ 17.3k | 1 | [#9007](https://github.com/windmill-labs/windmill/pull/9007) — fix: bind MySQL table listing to configured database name |
